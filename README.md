...
Setiap kelompok bertanggung jawab untuk mengimplementasikan fungsionalitas algoritma AI masing-masing pada berkas template HTML yang telah disediakan di folder `Web/templates/Kelompok_X/kelompok_X.html`.
...
| :--- | :--- | :--- | :--- | :--- |
| **Kelompok 1** | Analisis Kandungan Gizi Makanan | CNN (Visual & Weight Input) | Fase 3 | `Web/templates/Kelompok_1/kelompok_1.html` |
| **Kelompok 2** | Rekomendasi Menu Makanan | LSTM Sequence | Fase 1 | `Web/templates/Kelompok_2/kelompok_2.html` |
| **Kelompok 3** | Prediksi Kesukaan Menu MBG | DNN / LSTM Tabular | Fase 1 | `Web/templates/Kelompok_3/kelompok_3.html` |
| **Kelompok 4** | Analisis Sentimen Medsos | CNN-LSTM & Word Embedding | Fase 5 | `Web/templates/Kelompok_4/kelompok_4.html` |
| **Kelompok 5** | Deteksi Kontaminasi Benda Asing Makro | YOLO Object Detection | Fase 3 | `Web/templates/Kelompok_5/kelompok_5.html` |
| **Kelompok 6** | Analisis Sentimen Komentar YouTube | LSTM & Time Series Forecasting | Fase 5 | `Web/templates/Kelompok_6/kelompok_6.html` |
| **Kelompok 7** | Deteksi Sisa Makanan Piring Kotor | CNN Transfer Learning | Fase 4 | `Web/templates/Kelompok_7/kelompok_7.html` |
| **Kelompok 8** | Deteksi Kelengkapan Menu Tray | YOLOv8 Instance Segmentation | Fase 3 | `Web/templates/Kelompok_8/kelompok_8.html` |
| **Kelompok 9** | Prediksi Kebutuhan Distribusi | Artificial Neural Network (ANN) | Fase 1 | `Web/templates/Kelompok_9/kelompok_9.html` |
| **Kelompok 10**| Klasifikasi Kelayakan Gizi & Benda Asing Mikro | ERX Citra Hiperspektral | Fase 3 | `Web/templates/Kelompok_10/kelompok_10.html` |
| **Kelompok 11**| Sortir Kualitas Kesegaran Bahan Baku | CNN MobileNetV2 | Fase 2 | `Web/templates/Kelompok_11/kelompok_11.html` |
...
* **Hanya Edit Berkas Kelompok Anda**: Batasi modifikasi Anda pada folder kelompok masing-masing (misal: `Web/templates/Kelompok_X/`).
...
1. Simpan file bobot model Anda (seperti `.h5`, `.pt`, `.onnx`, atau `.bin`) ke dalam folder kelompok masing-masing (contoh: `Web/templates/Kelompok_X/model.h5`).
